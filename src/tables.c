...
const struct flag_type type_flags[] = {
    ...
    {"furnace", ITEM_SMITH_FURNACE , TRUE},
    {"ore", ITEM_SMITH_ORE, TRUE},
    {"anvil", ITEM_SMITH_ANVIL, TRUE},
    {"hammer", ITEM_SMITH_HAMMER, TRUE},
    {"barrel", ITEM_SMITH_BARREL, TRUE},
    {"grinder", ITEM_SMITH_GRINDER, TRUE},
    {NULL, 0, 0}
};
...
const struct flag_type wear_loc_strings[] = {
    ...
    {"worn on left ear", WEAR_EAR_1, TRUE},
    {"worn on right ear", WEAR_EAR_2, TRUE},
...
{
    /* Name */   /* Cost */  /* Vnum */    /* Type */
  {   "Fountain", 200,		29800,      OBJ_VNUM    },
  {   "pool", 500,	29799,      OBJ_VNUM    },
  {   NULL,          0,         0,          0,          }
};
