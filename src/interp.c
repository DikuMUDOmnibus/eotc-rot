...
bool double_improve = FALSE;
bool double_quest = TRUE;
bool no_wait_questing = TRUE;
bool double_pracs = FALSE;
bool double_damage = FALSE;
bool global_quest = FALSE;
bool its_christmas = FALSE;
bool special_day = TRUE;
bool is_reboot_countdown = FALSE;
bool reboot_countdown = 30;
bool stuff_was_changed = FALSE;
bool is_mass_arena = FALSE;
bool is_mass_arena_fight = FALSE;
int  top_playerid    = 0;
...
const struct cmd_type cmd_table[] = {
     ...
     *  Dragon
     */
        { "dragonform", do_drackform, POS_STANDING, 0, LOG_NORMAL, 1},
        { "fly", do_fly, POS_STANDING, 0, LOG_NORMAL, 1},

   /*
    * Eotc Xrakisis
    */
  { "calc", do_calc, POS_STANDING, 0, LOG_NORMAL, 1},
  { "objectgate", do_objectgate, POS_STANDING, 0, LOG_NORMAL, 1},
  { "gsocial", do_gsocial, POS_STANDING, 0, LOG_NORMAL, 1},
  { "bank", do_bank, POS_STANDING, 0, LOG_NORMAL, 1},
  { "superberserk", do_superberserk, POS_FIGHTING, 0, LOG_NORMAL, 1},
  { "focus", do_focus, POS_STANDING, 0, LOG_NORMAL, 1},
  { "claim", do_claim, POS_STANDING, 0, LOG_NORMAL, 1},
  { "gift", do_gift, POS_STANDING, 0, LOG_NORMAL, 1},
  { "call", do_call, POS_STANDING, 0, LOG_NORMAL, 1},
  { "leader", do_leader, POS_STANDING, 0, LOG_NORMAL, 1},
  { "leaderclear", do_leaderclear, POS_STANDING, 0, LOG_NORMAL, 211},
  { "mudinfo", do_mudinfo, POS_STANDING, 0, LOG_NORMAL, 1},
  { "becomedragon", do_becomedragon, POS_STANDING, 0, LOG_NORMAL, 1},
  { "version", do_version, POS_STANDING, 0, LOG_NORMAL, 1},

    {"consider",  do_consider,  POS_RESTING,  0, LOG_NORMAL, 1},


/* Powers level 200-206 */
        { "thirdeye", do_thirdeye, POS_STANDING, 0, LOG_NORMAL, 200},
        { "scry", do_scry, POS_STANDING, 0, LOG_NORMAL, 201},

/* Vamp and WW */
				{ "diseaseself", do_diseaseself, POS_STANDING, 0, LOG_NORMAL, 1},

        { "scream", do_scream, POS_FIGHTING, 0, LOG_NORMAL, 1}, // Vampire
        { "conceal", do_conceal, POS_STANDING, 0, LOG_NORMAL, 1}, // Vampire
    	  { "fear", do_fear, POS_FIGHTING, 0, LOG_NORMAL, 1}, // Vampire
				{ "moonbeam", do_moonbeam, POS_FIGHTING, 0, LOG_NORMAL, 1}, // Werewolf
        { "roar", do_roar, POS_FIGHTING, 0, LOG_NORMAL, 1}, // Werewolf
        { "leech", do_leech, POS_FIGHTING, 0, LOG_NORMAL, 1}, // Demon
        { "soulsuck", do_soulsuck, POS_FIGHTING, 0, LOG_NORMAL, 1}, // Undead



/* Clan */
	 { "clist",	do_clanlist,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 }, /* JEREMIAS */
	 { "petition",	do_petition,	POS_RESTING,	 0,  LOG_NORMAL, 1 }, /* JEREMIAS */
	 { "promote",	do_promote,	POS_DEAD,	 0,  LOG_NORMAL, 1 }, /* JEREMIAS */
	 { "demote",	do_demote,	POS_DEAD,	 0,  LOG_NORMAL, 1 }, /* JEREMIAS */
	 { "exile",	do_exile,	POS_RESTING,	 0,  LOG_NORMAL, 1 }, /* JEREMIAS */
	 { "clan",	do_clantalk,	POS_SLEEPING,	 0,  LOG_NORMAL, 1 },
	 { "loner",	do_loner,	POS_DEAD,	 0,  LOG_NORMAL, 1 }, /* JEREMIAS */
	{ "cleader",	do_cleader,		POS_DEAD,		L1,  LOG_NORMAL, 1 }, /* JEREMIAS */
	{ "guild",	do_guild,		POS_DEAD,		L4,  LOG_ALWAYS, 1 }, /* JEREMIAS */
	{ "cdeposit",   do_cdeposit,		POS_DEAD, 		0,   LOG_ALWAYS, 1}, /* Xrakisis n Jobo */
        { "cwithdraw",   do_cwithdraw,            POS_DEAD,               0,   LOG_ALWAYS, 1}, /* Xrakisis */

    {"pathfind", do_pathfind, POS_DEAD, 0, LOG_NORMAL, 1 },
    {"pathtest", do_pathtest, POS_DEAD, 0, LOG_NORMAL, 1 },
    { "quest",          do_quest,       POS_RESTING,     0,  LOG_NORMAL, 1 },
    {"directions", do_directions, POS_DEAD, 0, LOG_NORMAL, 1 },
    {"sstat", do_sstat, POS_DEAD, 0, LOG_NORMAL, 1 },
    {"stance", do_stance, POS_DEAD, 0, LOG_NORMAL, 1 },
    {"smith", do_smith, POS_STANDING, 0, LOG_NORMAL, 1},
    {"relevel",   do_relevel,   POS_DEAD,     0, LOG_NORMAL, 1},
    {"addchange",   do_addchange,   POS_DEAD,     ML, LOG_NORMAL, 1},
    {"delchange",   do_delchange,   POS_DEAD,     ML, LOG_NORMAL, 1},
...
//    {"consider",  do_consider,  POS_RESTING,  0, LOG_NORMAL, 1},
    ...
    {"gods", do_gods, POS_DEAD, 0, LOG_NORMAL, 1},
    {"toggle",   do_toggle,   POS_DEAD,     ML, LOG_NORMAL, 1},
    {"slist", do_slist, POS_DEAD, 0, LOG_NORMAL, 1},
    {"perm", do_perm, POS_DEAD, 0, LOG_NORMAL, 1},
    {"multiclass", do_multiclass, POS_DEAD, 0, LOG_NORMAL, 1},
    {"level", do_level, POS_DEAD, 0, LOG_NORMAL, 1},
    {"relinquish", do_relinquish, POS_STANDING, 0, LOG_NORMAL, 1},
...
/*  {"groups",    do_groups,    POS_SLEEPING, 0, LOG_NORMAL, 1}, */
    ...
    {"oldscore",  do_newscore,     POS_DEAD,     0, LOG_NORMAL, 1},
    ...
    {"brief2", do_brief2, POS_DEAD, 0, LOG_NORMAL, 1},
    {"brief3", do_brief3, POS_DEAD, 0, LOG_NORMAL, 1},
/*  { "channels",    do_channels,    POS_DEAD,     0,  LOG_NORMAL, 1 }, */
    ...
    {"hints", do_hints, POS_SLEEPING, 0, LOG_NORMAL, 1},
...
/*  { "auction",    do_auction,    POS_SLEEPING,     0,  LOG_NORMAL, 1 }, */
    ...
    {"ic", do_gossip, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"chat", do_chat, POS_SLEEPING, 0, LOG_NORMAL, 1},
    {"ooc", do_chat, POS_SLEEPING, 0, LOG_NORMAL, 1},
...
/*  { "unlock",        do_unlock,    POS_RESTING,     0,  LOG_NORMAL, 1 }, */
    ...
    {"bomuzite", do_bomuzite, POS_STANDING, 0, LOG_NORMAL, 1},
    ...
    {"cleave", do_cleave, POS_FIGHTING, 0, LOG_NORMAL, 1},
    ...
    {"jugularslice", do_jugular_slice, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"kick", do_kick, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"knee", do_knee, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"sidekick", do_sidekick, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"murde", do_murde, POS_FIGHTING, 0, LOG_NORMAL, 0},
    {"murder", do_murder, POS_FIGHTING, 5, LOG_ALWAYS, 1},
    {"precisionstrike", do_precisionstrike, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"rampage", do_rampage, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"rescue", do_rescue, POS_FIGHTING, 0, LOG_NORMAL, 0},
    {"skeletalhand", do_shand, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"surrender", do_surrender, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"trip", do_trip, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"unnerve", do_unnerve, POS_FIGHTING, 0, LOG_NORMAL, 1},
...
/*  { "practice",    do_practice,    POS_SLEEPING,     0,  LOG_NORMAL, 1 }, */
     ...
     * Immortal commands.
     */
    {"spellup",	 	do_spellup,     POS_DEAD, ML, LOG_ALWAYS, 1}, 
    {"cprime",          do_cprime,      POS_DEAD, ML, LOG_ALWAYS, 1}, // Coded by Hutoshi
    {"reimb",        do_reimb,      POS_DEAD, ML, LOG_ALWAYS, 1},
    ...
    {"autoreboot",      do_autoreboot,  POS_DEAD, L1, LOG_ALWAYS, 1},
    {"abort",           do_abort,       POS_DEAD, L1, LOG_ALWAYS, 1},
...
// Player home stuff --Landren

    { "house",do_house,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "objbuy",do_objbuy,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "mobbuy",do_mobbuy,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "hdesc",do_hdesc,	POS_RESTING,	 0, LOG_NORMAL, 1 },
    { "invite",do_invite,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "home",do_home,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "join",do_join,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
    { "hname",do_hname,	POS_RESTING,	 0,  LOG_NORMAL, 1 },
...
void interpret (CHAR_DATA * ch, char *argument)
{
	...
	{
	sprintf( buf,"{R%s{x is not a recognized command please type 'commands' to list them.\n\r",command );
	send_to_char (buf, ch);
	}
