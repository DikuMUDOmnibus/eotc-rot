...
// Eye of the Cyclops II, Xrakisis
DECLARE_DO_FUN( do_calc			); // by Xrak, just for fun
DECLARE_DO_FUN( do_objectgate		);
DECLARE_DO_FUN( do_gsocial		);
DECLARE_DO_FUN( do_thirdeye		); // Hero Only, Level 200
DECLARE_DO_FUN( do_scry			); // Veteran Only, Level 201
...
DECLARE_DO_FUN( do_becomedragon		);
DECLARE_DO_FUN( do_diseaseself		);
...
DECLARE_DO_FUN( do_scream		); // Vampire skill
DECLARE_DO_FUN( do_leech		); // Demon
DECLARE_DO_FUN( do_soulsuck ); // Undead
DECLARE_DO_FUN( do_second		);
DECLARE_DO_FUN( do_gods			);
DECLARE_DO_FUN( do_toggle		);
DECLARE_DO_FUN( do_slist		);
DECLARE_DO_FUN( do_newscore		);
DECLARE_DO_FUN( do_bomuzite		); // Ninja
DECLARE_DO_FUN( do_cleave		); // Paladin and Antipaladin
DECLARE_DO_FUN( do_precisionstrike	); // Samurai
DECLARE_DO_FUN( do_assassinate		); // Samurai, Ninja, Assassin
DECLARE_DO_FUN( do_jugular_slice	); // Samurai, Paladin, Anti-Paladin
...
DECLARE_DO_FUN( do_brief2               );	// Eotc
DECLARE_DO_FUN( do_brief3		);	// Eotc
DECLARE_DO_FUN(	do_bug			);
DECLARE_DO_FUN(	do_buy			);
DECLARE_DO_FUN(	do_cast			);
DECLARE_DO_FUN( do_cdeposit		);	// Eotc
...
DECLARE_DO_FUN( do_conceal		);	// Eotc Vampire
...
DECLARE_DO_FUN( do_fear			);	// Eotc Vampire
DECLARE_DO_FUN(	do_fill			);
DECLARE_DO_FUN( do_finger		);      // Finger Snippet
...
DECLARE_DO_FUN( do_moonbeam		);	// Eotc Werewolf
...
DECLARE_DO_FUN( do_roar			);	// Eotc Werewolf
DECLARE_DO_FUN(	do_rset			);
DECLARE_DO_FUN(	do_rstat		);
DECLARE_DO_FUN( do_rules		);
DECLARE_DO_FUN(	do_sacrifice		);
DECLARE_DO_FUN(	do_save			);
DECLARE_DO_FUN( do_autosave		); // by Xrak
