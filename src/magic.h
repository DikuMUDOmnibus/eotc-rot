...
DECLARE_SPELL_FUN(	spell_precision		); // 2x hitroll EotC
DECLARE_SPELL_FUN(  spell_forceshield		); // Shielding Spells
DECLARE_SPELL_FUN(  spell_staticshield		); // Shielding Spells
DECLARE_SPELL_FUN(  spell_flameshield		); // Shielding Spells
DECLARE_SPELL_FUN(	spell_null		);
DECLARE_SPELL_FUN(	spell_acetum_primus	); // Anatolia	
DECLARE_SPELL_FUN(	spell_achilles		); // EotC
DECLARE_SPELL_FUN(	spell_acid_arrow	); // Anatolia
DECLARE_SPELL_FUN(	spell_acid_blast	);
DECLARE_SPELL_FUN(      spell_acute_vision      ); // Anatolia
DECLARE_SPELL_FUN(	spell_adamantite_golem	); // Anatolia
DECLARE_SPELL_FUN(	spell_aid		);
DECLARE_SPELL_FUN(	spell_animal_instinct	);
DECLARE_SPELL_FUN(	spell_animate_dead	); // Anatolia
DECLARE_SPELL_FUN(	spell_armor		);
DECLARE_SPELL_FUN(	spell_assist		); // Anatolia
DECLARE_SPELL_FUN(	spell_astral_walk	); // Anatolia
...
DECLARE_SPELL_FUN(	spell_cocoon		); // -Xrak 2x sanc
...
DECLARE_SPELL_FUN(	spell_godsword		);
...
DECLARE_SPELL_FUN(	spell_improved_heal	);
DECLARE_SPELL_FUN(	spell_invis		);
DECLARE_SPELL_FUN(	spell_investiture	);
DECLARE_SPELL_FUN(	spell_knightshield	); // Xrakisis
...
DECLARE_SPELL_FUN(	spell_mental_knife	); // Psyche group
...
DECLARE_SPELL_FUN(	spell_wrath_of_god	); // Bishop, Xrakisis
