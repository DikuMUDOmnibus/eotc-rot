...
*/
    ...
    if ( !str_cmp ( arg1, "points" ) )
    {
        sprintf ( buf,
                  ...
                  ch->pcdata->questpoints, ch->questpoints );
        send_to_char ( buf, ch );
        return;
    }
...
*/
	...
	else 
	{
		    ...
		    pracreward = number_range ( 1, 6 );
                ...
                if ( chance ( 15 ) )
                {
//	          if ( IS_SET ( ch->act2, PLR2_NO_EXP ) && ( ch->level <= 
//LEVEL_HERO ) )
         	  //send_to_char ( "You receive no exp as reward cause you've got 
//noexp on.\n\r", ch );
		  //else
		  {  
/*      		    if ( is_real_pkiller ( ch ) )
...
//	          if ( IS_SET ( ch->act2, PLR2_NO_EXP ) && ( ch->level <= 
//LEVEL_HERO ) )
                  //send_to_char ( "You receive no exp as reward cause you've 
//got noexp on.\n\r", ch );
//		  else
/*      		    if ( is_real_pkiller ( ch ) )
		    {
